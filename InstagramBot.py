...
class InstaBot:
	def __init__(self, username, pw):
		self.driver = webdriver.Chrome(executable_path="") #insert path to chromedriver here or replace with line 7 if chromedriver is in system path
...
myBot = InstaBot('', '') #call InstaBot with your username and passwors
myBot.getUnfollowers()

#usernames will appear as a list in Console